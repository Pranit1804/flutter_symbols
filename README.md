...
[![pub version](https://img.shields.io/pub/v/flutter_symbols.svg)](https://pub.dev/packages/flutter_symbols)
[![pub points](https://img.shields.io/pub/points/flutter_symbols)](https://pub.dev/packages/flutter_symbols/score)
...
4. **dart** — Dart script generates `lib/flutter_symbols.dart` with all constants
